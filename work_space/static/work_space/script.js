...
function create_author_fields(author_number) {
    ...
    if (author_number != 1) {
        ...
        <div class="author" id="author_fields_${author_number}">
            <label>Author Last Name: <input id="author_last_name_${author_number}" type="text" required></label>
            <label>Author First Name: <input id="author_first_name_${author_number}" type="text"></label>
            <label>Author Second Name: <input id="author_second_name_${author_number}" type="text"></label>
...
function count_and_set_authors_number() {
    const final_number_of_authors = forms[i].getElementsByClassName('author').length;
    forms[i].querySelector('.final_number_of_authors').value = final_number_of_authors;
}
